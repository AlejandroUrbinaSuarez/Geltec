        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center gap-3 mb-5">
              ...
              <span className="font-heading text-xl font-bold text-white">Geltec Consultores</span>
            </div>
              ...
              <div className="flex items-center gap-3 mt-6">
                {activeSocials.map((social) => (
                  <a
                    ...
                    className="w-9 h-9 rounded-lg bg-white/10 flex items-center justify-center text-white/60 hover:bg-secondary hover:text-primary transition-all duration-200"
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-start gap-3">
                ...
                <span className="text-sm text-white/60">+573209104055</span>
              </li>
              <li className="flex items-start gap-3">
                <MapPin size={16} className="text-secondary mt-0.5 shrink-0" />
                <span className="text-sm text-white/60">Cúcuta, Colombia</span>
              </li>
            </ul>
          </div>
        </div>
